    ...
    #processNode(node) {
        ...
        switch (node.type) {
            ...
            case 'ArrowFunctionExpression': {
                ...
                node.params.forEach(this.#processNodeAsDefinition.bind(this, 2 /* DefinitionKind.Var */));
            ...
            case 'CatchClause':
                this.#pushScope(node.start, node.end);
                this.#processNodeAsDefinition(1 /* DefinitionKind.Let */, node.param);
                this.#processNode(node.body);
                this.#popScope(false);
                break;
            case 'ClassBody':
            ...
            case 'ClassDeclaration':
                this.#processNodeAsDefinition(1 /* DefinitionKind.Let */, node.id);
            ...
            case 'FunctionDeclaration':
                this.#processNodeAsDefinition(2 /* DefinitionKind.Var */, node.id);
                ...
                node.params.forEach(this.#processNodeAsDefinition.bind(this, 1 /* DefinitionKind.Let */));
            ...
            case 'Property':
                ...
                break;
            case 'RestElement':
                this.#processNodeAsDefinition(1 /* DefinitionKind.Let */, node.argument);
                break;
